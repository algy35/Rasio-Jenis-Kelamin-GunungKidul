...
var style_RasioJenisKelamin_GunungKidul_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Rasio Jeni");
    ...
    if (value >= 94.060000 && value <= 96.773333) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 96.773333 && value <= 98.393333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 98.393333 && value <= 100.360000) {
            style = [ new ol.style.Style({
